...
import { d as defineCommand, L, C } from '../shared/nuxi.fefc5017.mjs';
import './index2.mjs';
import 'node:http';
import 'node:https';
import 'node:util';
...
import { s as setupDotenv } from '../shared/nuxi.16bb8ddb.mjs';
import 'node:url';
...
function _resolveListenOptions(nuxtOptions, args) {
  ...
  const _hostname = typeof args.host === "string" ? args.host : (args.host === true ? "" : void 0) ?? process.env.NUXT_HOST ?? process.env.NITRO_HOST ?? process.env.HOST ?? nuxtOptions._layers?.[0].config?.devServer?.host ?? void 0;
